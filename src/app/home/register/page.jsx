...
import { signUp, signIn } from "@/lib/auth-client"; // 👈 signIn ও ইম্পোর্ট করা হলো
        ...
        fetchOptions: {
          ...
          onError: (context) => {
            if (context.error.status === 422) {
              toast.error(context.error.message || "Email already in use or invalid data.");
            } else {
        ...
        <div className="space-y-1">
          ...
          <div className="pt-1">
            ...
            <p className="text-zinc-500 text-[11px] font-medium">
              Join as a tenant and start browsing rentals
            </p>
          </div>
        </div>
