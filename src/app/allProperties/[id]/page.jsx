...
import LoadingDetails from "@/components/Deshboard/Owner/LoadingDetails";

export default function PropertyDetails({ isLoading, propertyData }) {
  const [isFavorite, setIsFavorite] = useState(false);

  // ডামি ডাটা অবজেক্ট (যদি প্রপ্স থেকে ডাটা না আসে, তবে এটি ব্যবহার হবে)
  const defaultProperty = {
    id: 1,
    title: "Sunrise residency",
    location: "Gulshan, Dhaka",
    price: "Tk 18,000",
    description: "A bright and spacious apartment close to shopping and transport links. Recently renovated with modern fittings, secure entry, and a quiet, family-friendly building.",
    owner: "Mahmud Rahman",
    bedrooms: 3,
    bathrooms: 2,
    size: "1450 sqft",
  ...
  // ১. প্রপ্স থেকে ডাটা আসলে সেটা নিবে, না আসলে ডামি ডাটা নিবে
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start w-full">
                <div className="space-y-1">
                  <h1 className="text-4xl md:text-5xl font-black tracking-tight text-zinc-100">{property.title}</h1>
              ...
              <div className="text-3xl md:text-4xl font-black">
                <span className="text-[#46cba1]">{property.price}</span>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-[#09110e] border border-[#1b352b] rounded-xl text-sm font-bold text-[#46cba1]">
                  <Maximize size={16} /> {property.size}
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-[#09110e] border border-[#1b352b] rounded-xl text-sm font-bold text-[#46cba1]">
                  <Wifi size={16} /> Wifi
                </div>
            ...
            <div className="space-y-4 pt-4">
              <div className="bg-transparent border border-zinc-900 p-4 rounded-2xl flex items-center justify-between w-full shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-zinc-200">{property.owner}</h4>
                    <p className="text-sm text-zinc-500 font-medium tracking-wide uppercase">Property owner</p>
                  </div>
                </div>
                <Button 
                  size="sm" 
